...
# Default DB name for this app
	define('DB_NAME', 'adelsber_p4_adelsberger_us'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'ssx!HzUqX6MgrVJ7D7ZZg^@Njjl4ZCup&q(kTykw');
	define('TOKEN_SALT', 'lqm)iZv*g8)C!r3ZFvYlw^qmmrern4D64sj#DKEd');